...
public class ArrayAdapterTaiKhoanMain extends android.widget.ArrayAdapter{
    ...
    public ArrayAdapterTaiKhoanMain(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<TaiKhoan> objects) {
...
convertView.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent starter = new Intent(context, ChinhSuaTaiKhoanActivity.class);
        int id=contact.getIdtaikhoan();
        starter.putExtra("id",id);


        ((Activity)getContext()).startActivityForResult(starter, 2);
